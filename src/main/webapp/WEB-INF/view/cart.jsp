              ...
              <div class="col-lg-6 px-5 py-4">
                ...
                <div class="d-flex align-items-center mb-5">
                  ...
                  <div class="flex-grow-1 ms-3">
                    ...
                    <h6 style="color: #9e9e9e;">Màu: trắng</h6>
                ...
                <div class="d-flex align-items-center mb-5">
                  ...
                  <div class="flex-grow-1 ms-3">
                    ...
                    <h6 style="color: #9e9e9e;">Màu: đỏ</h6>
                    <div class="d-flex align-items-center">
                ...
                <div class="d-flex align-items-center mb-5">
                  ...
                  <div class="flex-grow-1 ms-3">
                    ...
                    <h6 style="color: #9e9e9e;">Màu: hồng hồng</h6>
                    <div class="d-flex align-items-center">
                ...
                <form class="mb-5">
                  ...
                  <div data-mdb-input-init class="form-outline mb-5">
                    ...
                    <input type="text" id="typeText" class="form-control form-control-lg" siez="17"
                      value="0393378***" minlength="19" maxlength="19" />
                  ...
                  <button  type="button" data-mdb-button-init data-mdb-ripple-init class="btn btn-primary btn-block btn-lg">Mua Ngay</button>
